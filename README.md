...
- `operands` - регистр, содержащий часть команды с операндами
...
2. Тип команды, опкод и расширение опкода уходят в `IR`, операнды в `operands`
...
- `latch_ops` - защелкнуть значение в `operands`
...
- Выполнение микропрограмм происходит в функции
- Цикл декодирования и выполнения инструкций происходит в функции
